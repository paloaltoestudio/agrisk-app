...
const EntriesContextProvider = props => {
    ...
    const fields = ['tipoCultivo', 'in_id_vereda', 'pais', 'departamento', 'municipio', 'direccion',  'in_id_sistema_productivo', 'in_rendimiento_cultivo', 'in_costos_produccion_cultivo', 'in_area_cultivo', 'respuesta_1', 'respuesta_2', 'respuesta_3', 'respuesta_4', 'respuesta_5', 'respuesta_6','respuesta_7', 'respuesta_8', 'respuesta_9', 'respuesta_10'];
